# GStreamer 1.26.0 recipe for Conversa v2.0 support
# Based on the i.MX fork pattern but updated to 1.26.0
...
# Use NXP i.MX fork of GStreamer 1.26.0 for hardware acceleration
